$(document).ready(function () {
    const apiRoot = 'https://kodilla-tasks-prod-kodilla-tasks-petq1j.mo5.mogenius.io/v1/tasks';
    const trelloApiRoot = 'https://kodilla-tasks-prod-kodilla-tasks-petq1j.mo5.mogenius.io/v1/trello';
