...
const apiRoot = 'https://mateusz-crud.herokuapp.com/v1/trello';
...
var taskTitle = parentEl.find('[data-task-nameinput]').
val();
...
parentEl.find('[data-task-nameparagraph]').
text(taskTitle);
...
var taskTitle = parentEl.find('[data-task-nameparagraph]').
text();
var taskContent = parentEl.find('[data-taskcontent-paragraph]').text();
parentEl.find('[data-task-nameinput]').
val(taskTitle);
parentEl.find('[data-task-contentinput]').
val(taskContent);
}
...
prepareBoardOrListSelectOptions(availableBoards[selectedBoardId
...
var selectedListId =
$relatedTaskRow.find('[data-list-nameselect]').
val();
if (!selectedListId) {
